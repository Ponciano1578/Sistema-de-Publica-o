...
public class TelaLeiComplementar extends JFrame {

    private ArrayList<ArmazenamentoLeiComplementar> informacoes = new ArrayList<ArmazenamentoLeiComplementar>();

    private JLabel labellink;
    private JTextField campolink;
    private JLabel labelNomeLeiComplementar;
    private JTextField campoNomeLeiComplementar;
    ...
    private class MeuModeloTabela extends AbstractTableModel {
        ...
        private ArrayList<ArmazenamentoLeiComplementar> dados;

        public MeuModeloTabela(ArrayList<ArmazenamentoLeiComplementar> dados) {
            this.dados = dados;
        }
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            ArmazenamentoLeiComplementar info = dados.get(rowIndex);
            switch (columnIndex) {
                case 0:
                    return info.getNomeLeiComplementar();
                case 1:
    ...
    public TelaLeiComplementar() {
        // Configurações da janela
        setTitle("PUBLICANDO LEI COMPLEMENTAR");
        setSize(700,600);
        ...
        labelNomeLeiComplementar = new JLabel("Número da Lei:");
        labelNomeLeiComplementar.setBounds(24, 45, 137, 14);
        campoNomeLeiComplementar = new JTextField(20);
        campoNomeLeiComplementar.setBounds(160, 45, 511, 20);
        ...
        getContentPane().add(labelNomeLeiComplementar);
        getContentPane().add(campoNomeLeiComplementar);
        ...
        botaoAdicionar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String NomeLeiComplementar = campoNomeLeiComplementar.getText();
                String TextoLei = campoTextoLei.getText();
                ArmazenamentoLeiComplementar info = new ArmazenamentoLeiComplementar(link, NomeLeiComplementar, TextoLei);
                informacoes.add(info);
                MeuModeloTabela modelo = (MeuModeloTabela) tabelaInformacoes.getModel();
                modelo.fireTableDataChanged();
                campolink.setText("");
                campoNomeLeiComplementar.setText("");
     ...
     // Adicionando ação para o botão de exclusão
		...
		botaoEditar.addActionListener(new ActionListener() {
			...
			int selectedRow = tabelaInformacoes.getSelectedRow();
			if (selectedRow != -1) {
			ArmazenamentoLeiComplementar info = informacoes.get(selectedRow);
			campoNomeLeiComplementar.setText(info.getNomeLeiComplementar());
			...
			botaoSalvarAlteracoes.addActionListener(new ActionListener() {
			     public void actionPerformed(ActionEvent e) {
			        ...
			        for (int i = 0; i < selectedRows.length; i++) {
			           // Recuperando o objeto ArmazenamentoLeiComplementar correspondente à linha selecionada
			           ArmazenamentoLeiComplementar info = informacoes.get(selectedRows[i]);
			           // Salvando as alterações feitas nos campos de texto para o objeto ArmazenamentoLeiComplementar
			           info.setNomeLeiComplementar(campoNomeLeiComplementar.getText());
        ...
        botaoMostrarDados.addActionListener(new ActionListener() {
        	  public void actionPerformed(ActionEvent e) {
        	    ...
        	    // Append the information from the "ArmazenamentoAta" objects to the JTextArea
        		  for (ArmazenamentoLeiComplementar info : informacoes ) {
        			  areaTexto.append("<tr style=\"cursor: default;\">");
                      areaTexto.append("<td><div>"+ info.getNomeLeiComplementar()+"</div></td>\n");
                      areaTexto.append("<td><div align=\"justify\">"+info.getTextoLei()+"</div></td>\n");
                      areaTexto.append("<td><div align=\"heigh\"><a href=\"../../leis/leis_complementares/"+ info.getLink()+".pdf\" target=\"blank\"><img src=\"../wp-content/uploads/2017/03/baixar-150x150.png\" alt=\"\" width=\"40\" height=\"40\" border=\"0\"></a></div></td>\n");
                      areaTexto.append("</tr>\n");
                      areaTexto.append("\n");
        	    }
    ...
    public void mostrarDados() {
    	for (ArmazenamentoLeiComplementar info : informacoes ) {
			...
			System.out.println("<td><div>"+ info.getNomeLeiComplementar()+"</div></td>\n");
			System.out.println("<td><div align=\"justify\">"+info.getTextoLei()+"</div></td>\n");
			System.out.println("<td><div align=\"heigh\"><a href=\"../../leis/leisordinarias/2022/"+ info.getLink()+".pdf\" target=\"blank\"><img src=\"../wp-content/uploads/2017/03/baixar-150x150.png\" alt=\"\" width=\"40\" height=\"40\" border=\"0\"></a></div></td>\n");
        ...
        if (escolha == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                for (ArmazenamentoLeiComplementar info : informacoes ) {
                    ...
                    escritor.write("<td><div>"+ info.getNomeLeiComplementar()+"</div></td>\n");
                    escritor.write("<td><div align=\"justify\">"+info.getTextoLei()+"</div></td>\n");
                    escritor.write("<td><div align=\"center\"><a href=\"../../leis/leis_complementares/"+ info.getLink()+".pdf\" target=\"blank\"><img src=\"../wp-content/uploads/2017/03/baixar-150x150.png\" alt=\"\" width=\"40\" height=\"40\" border=\"0\"></a></div></td>\n");
                    escritor.write("</tr>\n");
                    escritor.write("\n");
